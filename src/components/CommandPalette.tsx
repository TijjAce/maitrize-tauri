...
const SOUS_ONGLETS: { ico: string; label: string; to: string; page: string; onglet: string; sous: string }[] = [
  ...
  { ico: "📖", label: "Scénario social", to: "/jeux", page: "jeux", onglet: "scenario", sous: "Fabriquer · Supports visuels" },
  { ico: "⏱", label: "Minuteur visuel", to: "/jeux", page: "jeux", onglet: "minuteur", sous: "Fabriquer · Supports visuels" },
