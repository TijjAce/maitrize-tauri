...
export function demarrerLaVeille(ecrire: (ligne: string) => void = journal): () => void {
  ...
  const id = setInterval(() => {
    ...
    const ligne = messageDeBlocage(ecart, typeof document !== "undefined" && document.hidden, ouSuisJe());
