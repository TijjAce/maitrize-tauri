...
export const NOUVEAUTES: Nouveaute[] = [
  {
    ...
    points: [
      ...
      { quoi: "Le texte de la réunion s'écrit tout seul, en continu, au lieu d'arriver par blocs de cinq minutes. Il se replie sous « Ce qui se dit » — c'est la source, le document, c'est le compte rendu. Vous pouvez le corriger, et même taper vous-même sans micro : une réunion se prend parfois au clavier.", ou: "Réunions · Ce qui se dit" },
      { quoi: "Le compte rendu n'est plus une liste de résumés mis bout à bout : c'est un document unique, que l'IA reprend toutes les dix phrases. Ce qui est nouveau va sous le bon titre, ce qui se répète fusionne, et une piste devenue décision change de rubrique — points abordés, décisions, ce que je dois faire, à revoir.", ou: "Réunions · Compte rendu" },
