...
export const NOUVEAUTES: Nouveaute[] = [
  {
    ...
    points: [
      ...
      { quoi: "Un seul encadré, où le texte s'écrit tout seul pendant la réunion — lettre après lettre, comme s'il se tapait sous vos yeux. Vous pouvez mettre la main dedans à tout moment : l'animation s'arrête, tout s'affiche, et vous corrigez.", ou: "Réunions · Compte rendu" },
