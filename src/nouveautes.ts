...
export const NOUVEAUTES: Nouveaute[] = [
  {
    ...
    points: [
      ...
      { quoi: "Un seul encadré, de la taille d'une page — le même que l'éditeur de textes —, où le texte s'écrit tout seul pendant la réunion, lettre après lettre. Vous pouvez mettre la main dedans à tout moment : l'animation s'arrête, tout s'affiche, et vous corrigez.", ou: "Réunions" },
      { quoi: "Plus rien à cliquer pour démarrer : une nouvelle réunion écoute d'elle-même. L'écran d'information ne s'affiche qu'une fois, la première ; ensuite il ne reste que Pause et Terminer. L'objet, le type et les participants se replient pendant la réunion pour laisser la place au texte, et reviennent par « Détails ».", ou: "Réunions" },
      ...
      { quoi: "Toutes les deux phrases, une seconde IA relit tout le compte rendu et le resserre : elle voit les redites qu'un passage seul ne peut pas voir. Elle ne supprime jamais une décision, une échéance ni un engagement, et si elle échoue, le document d'avant reste intact.", ou: "Réunions" },
      { quoi: "La case « Relecture » l'arrête quand vous n'en voulez pas, et un avertissement dit ce qu'elle implique : elle passe par l'IA en ligne, même quand la transcription, elle, reste sur votre ordinateur. Décochée, plus rien ne sort de la machine en mode local.", ou: "Réunions" },
      ...
      { quoi: "En local, la parole part se faire transcrire toutes les douze secondes au lieu de quarante-cinq : ni quota ni réseau à ménager, donc le texte arrive presque tout de suite. Un bouton « Tester le moteur local » vérifie l'installation avant la réunion, plutôt qu'au milieu.", ou: "Réglages · IA" },
