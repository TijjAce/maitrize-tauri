...
export const NOUVEAUTES: Nouveaute[] = [
  {
    ...
    points: [
      ...
      { quoi: "Les évaluations : clic droit sur le bureau › « Nouvelle évaluation ». Choisissez la compétence évaluée, dites comment faire passer l'évaluation, et joignez le sujet en PDF. Elles se rangent en dossiers comme le reste, et se déposent sur un bureau commun.", ou: "Plan de travail · clic droit · 📋 Nouvelle évaluation" },
