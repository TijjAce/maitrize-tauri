...
export const NOUVEAUTES: Nouveaute[] = [
  {
    ...
    points: [
      ...
      { quoi: "Toutes les dix phrases, une seconde IA relit tout le compte rendu et le resserre : elle voit les redites qu'un passage seul ne peut pas voir. Elle ne supprime jamais une décision, une échéance ni un engagement, et si elle échoue, le document d'avant reste intact. Le bouton « 🔁 Relecture » l'arrête quand vous n'en voulez pas — un appel de moins toutes les dix phrases.", ou: "Réunions" },
