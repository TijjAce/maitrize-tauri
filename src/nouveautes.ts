...
export const NOUVEAUTES: Nouveaute[] = [
  {
    ...
    points: [
      ...
      { quoi: "La transcription sur cet ordinateur se met en route sans terminal : l'application trouve whisper.cpp là où il est installé, et le modèle se télécharge depuis les Réglages — une fois, avec du réseau, et la réunion de mardi se passe de tout. L'écran dit ce qui manque encore, et la commande d'installation se copie d'un clic.", ou: "Réglages · IA · Transcription des réunions" },
