...
export const NOUVEAUTES: Nouveaute[] = [
  {
    ...
    points: [
      { quoi: "Une page de garde, un mot aux familles ou une liste de fournitures se composent en cochant : ce que la page doit porter, ce que le mot doit dire, ce que la liste doit contenir. Le champ libre demandait de décrire tout cela en prose — il reste, pour ce qu'aucune case ne prévoit.", ou: "Organisation · Pages de garde · ＋ Nouveau document" },
      { quoi: "Chaque case sait deux choses : la phrase qu'elle écrit toute seule, et ce qu'elle demande au modèle. « Partir d'un modèle » et « ✨ Rédiger avec l'IA » donnent donc le même document, l'IA n'ajoutant que le style. Décocher « Un rendez-vous est toujours possible » retire ce paragraphe, dans les deux cas.", ou: "Organisation · Pages de garde" },
      { quoi: "Soixante-deux fournitures relevées sur de vraies listes d'écoles, de maternelles et de dispositifs ULIS — de la seconde trousse à l'attestation d'assurance, en passant par la réserve de colles pour l'année. En unité d'enseignement, elles changent : change complet, serviette de table, doudou, et un groupe entier « Si votre enfant en a besoin » — casque anti-bruit, coussin d'assise, minuteur visuel, règle-loupe.", ou: "Organisation · Pages de garde · Fournitures scolaires" },
      { quoi: "Le lignage des cahiers se choisit une fois pour toute la liste : grands carreaux Seyès, Seyès agrandi 3 mm, 2,5 mm, petits carreaux, pages unies, lignage coloré — avec le nombre de pages, la couverture et le grammage. En IME, le Seyès agrandi de 3 mm est proposé d'office : c'est celui qu'on conseille tant que le geste s'apprend.", ou: "Organisation · Pages de garde · Fournitures scolaires" },
      { quoi: "La fenêtre ne se fige plus en listant les bureaux communs. Elle interrogeait chaque dossier partagé depuis le fil principal : sur un dossier réseau démonté, la question peut s'obstiner dix secondes — et cinquante des cinquante-neuf blocages relevés en quatre jours portaient cette page. Trente-huit opérations lourdes ont quitté ce fil, dont l'export, les PDF et la banque de pictogrammes.", ou: "Plan de travail" },
      { quoi: "L'export manuel ne contient plus aucun secret. Le texte promettait que la clé de l'IA n'y figurait pas, et c'était vrai — mais le fichier emportait en clair la clé du stockage, la phrase qui protège les sauvegardes déposées dessus et le jeton du téléphone. Sur une clé USB, c'était la serrure posée à côté de la clé. Après une restauration, elles sont à ressaisir.", ou: "Réglages · Données & synchro · 💾 Export manuel" },
      { quoi: "Le journal d'incidents n'écrit plus mille fois la même panne : le premier échec s'inscrit, les suivants se comptent, et la série se referme par « la même erreur 41 fois de suite, sur 3 h 20 ». Il en comptait cinq cent cinquante-quatre en quatre jours, la même phrase recopiée, qui noyait les rares lignes utiles.", ou: "Réglages · Données & synchro · 🩺 Journal d'incidents" },
      { quoi: "Les vacances scolaires ne se redemandent plus qu'une fois par jour : le calendrier est publié une fois l'an, et l'application interrogeait le ministère à chaque ouverture du planning — quatre-vingt-quatre échecs de réseau pour rien.", ou: "Planning" },
      { quoi: "L'ouverture est plus rapide : la copie quotidienne de la base, qui recopie tout, se fait désormais après l'apparition de la fenêtre et non avant. Et la bibliothèque qui dessine les PDF, près d'un mégaoctet, n'est chargée qu'au premier PDF ouvert.", ou: "au démarrage" },
      { quoi: "Une ligne écrite quarante fois de suite ne part plus quarante fois en synchronisation : seule la dernière compte. L'enregistrement automatique recopiait le document entier à chaque frappe — un texte travaillé une matinée hors réseau faisait quarante versions à envoyer au retour.", ou: "Réglages · Données & synchro" },
      { quoi: "Les dernières lignes du cahier journal ne se perdent plus en silence : l'écriture faite au moment où l'on change de jour échouait sans un mot, et le dernier paragraphe n'existait plus nulle part.", ou: "Planning · cahier journal" },
      { quoi: "« Données & synchro » alignait neuf cartes sans hiérarchie, de l'appairage au journal d'incidents. Elles se rangent en trois familles — vos machines, les sauvegardes, cet ordinateur — et ce qu'on n'ouvre qu'un jour de panne se replie derrière « Vérifier, exporter, diagnostiquer ».", ou: "Réglages · Données & synchro" },
      { quoi: "Un ordinateur qui figure deux fois, ou qui n'existe plus, se retire enfin de la liste. Il se réinscrira tout seul s'il se synchronise encore — et cet ordinateur-ci ne peut pas s'effacer lui-même, ce qui fausserait la liste chez les autres.", ou: "Réglages · Données & synchro · Mes appareils" },
