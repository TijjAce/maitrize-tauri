...
export const NOUVEAUTES: Nouveaute[] = [
  {
    ...
    points: [
      ...
      { quoi: "Le tableau de bord montre la semaine, et non plus le seul jour : chaque jour qui porte des créneaux, aujourd'hui en tête avec le détail de son prévu, et ce qui reste sans bilan. Un clic sur un jour ouvre son cahier journal.", ou: "Tableau de bord · 🗓️ Cette semaine" },
